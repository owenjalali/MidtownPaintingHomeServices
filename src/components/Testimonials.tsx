...
const Testimonials = () => {
    ...
    return (
        <section id="testimonials" ref={sectionRef} className="py-32 md:py-48 bg-[#020617] text-paper w-full">
            <div className="max-w-7xl mx-auto px-6 lg:px-12">

                <div className="mb-16 md:mb-24 flex flex-col items-center text-center">
                    <span className="font-data text-accent text-sm uppercase tracking-widest font-bold mb-4">
                        Client Verification
                    </span>
                    <h2 className="text-4xl md:text-5xl lg:text-7xl font-heading font-bold text-white max-w-3xl">
                ...
                <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
                    {testimonials.map((t, i) => (
                        <div
                            key={i}
                            className="testimonial-card break-inside-avoid bg-[#0f172a] border border-white/5 p-8 rounded-[2rem] hover:border-accent/40 transition-colors shadow-2xl"
                        >
                            ...
                            <p className="font-drama text-2xl leading-snug text-white/90 mb-8 italic">
                                "{t.quote}"
                            </p>
                            <div className="flex flex-col">
                                <span className="font-heading font-bold text-lg text-white">{t.author}</span>
