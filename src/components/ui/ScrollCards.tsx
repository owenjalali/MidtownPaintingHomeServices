...
const cardVariants = cva("absolute will-change-transform", {
  variants: {
    variant: {
      dark: "flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-stone-700/50 bg-midtown-navy/90 p-6 backdrop-blur-md text-white",
      light:
        "flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-gray-200 bg-white p-6 shadow-xl",
    },
  },
  defaultVariants: {
    variant: "light",
...
>(
  (
    ...
    // Always call the hook to follow React's rules of hooks
